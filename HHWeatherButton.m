...
- (instancetype) initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _weatherImageView = [[UIImageView alloc] initWithFrame:CGRectMake(147, 118, 75, 75)];
        ...
        _weatherLabel.font = [UIFont fontWithName:@"AvenirNext-MediumItalic" size:29];
        _weatherLabel.textAlignment = NSTextAlignmentCenter;
        _weatherLabel.textColor = TEXTCOLOR;
        [self addSubview:_weatherLabel];
        
        _tempLabel = [[UILabel alloc] initWithFrame:CGRectMake(120, 285, 135, 69)];
        _tempLabel.font = [UIFont fontWithName:@"AvenirNext-UltraLight" size:60];
